    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className='mt-5'>
          ...
          <p className={`mt-2 ${isDarkMode ? 'text-secondary' : 'text-light-secondary'} text-[14px]`}>{description}</p>
        </div>
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} ${isDarkMode ? 'text-secondary' : 'text-light-secondary'}`}>My work</p>
        <h2 className={`${styles.sectionHeadText} ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Projects.</h2>
      </motion.div>
